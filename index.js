...
(function($PS) {
  "use strict";
  $PS["Page.Article"] = $PS["Page.Article"] || {};
  var exports = $PS["Page.Article"];
  var CSS_Stylesheet = $PS["CSS.Stylesheet"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Category = $PS["Control.Category"];
  var Data_Function = $PS["Data.Function"];
  ...
  // css
  var css = Control_Applicative.pure(CSS_Stylesheet.applicativeStyleM)(Data_Unit.unit);

  // component
  var articleComponent = Halogen_Component.mkComponent({
      initialState: Control_Category.identity(Control_Category.categoryFn),
      render: Data_Function["const"](Halogen_HTML_Core.text("article")),
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var _articleComponent = Type_Proxy["Proxy"].value;
  exports["css"] = css;
  exports["articleComponent"] = articleComponent;
  exports["_articleComponent"] = _articleComponent;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  ...
  var Page_Article = $PS["Page.Article"];                
  var mainComponent = Halogen_Component.mkComponent({
      initialState: Control_Category.identity(Control_Category.categoryFn),
      render: Data_Function["const"](Halogen_HTML.slot_()({
          reflectSymbol: function () {
              return "articleComponent";
          }
      })(Data_Ord.ordUnit)(Page_Article["_articleComponent"])(Data_Unit.unit)(Page_Article.articleComponent)(Data_Unit.unit)),
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var css = Page_Article.css;
  var cssComponent = Halogen_Component.mkComponent({
      initialState: Control_Category.identity(Control_Category.categoryFn),
      render: Data_Function["const"](Halogen_HTML_CSS.stylesheet(css)),
      "eval": Halogen_Component.mkEval(Halogen_Component.defaultEval)
  });
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Bind.bindFlipped(Effect_Aff.bindAff)(Data_Foldable.traverse_(Effect_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(cssComponent)(Data_Unit.unit)))(Halogen_Aff_Util.selectElement("head")))(function () {
